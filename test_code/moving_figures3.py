...
class Circle:
    def __init__(self, x, y, r, color):
        ...
        self.turn_speed = random.uniform(-math.pi, math.pi)
...
def detect_collisions(circle1, circle2):
    ...
    if distance <= (circle1.r + circle2.r):
        ...
        circle1.turn_speed = -circle1.turn_speed * random.uniform(0.8, 1.2)
        circle2.turn_speed = -circle2.turn_speed * random.uniform(0.8, 1.2)
...
def update_circles():
    for c1 in circles:
        ...
        for c2 in circles:
            ...
            if c2.x - c2.r <= 0 or c2.x + c2.r >= 750:
                c2.vx = -c2.vx
                c2.turn_speed = -c2.turn_speed * random.uniform(0.8, 1.2)
            if c2.y - c2.r <= 0 or c2.y + c2.r >= 500:
                c2.vy = -c2.vy
                c2.turn_speed = -c2.turn_speed * random.uniform(0.8, 1.2)

            # Update angle based on turn speed
            c2.turn_direction += c2.turn_speed / 100 * c2.turn_direction
